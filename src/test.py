...
class TestCalculatePossibleMoves(unittest.TestCase):
    ...
    def check_missing_and_extra_moves(self, fen, player, expected_moves, actual_moves):
    ...
    def run_test_case(self, case):
        ...
        actual_moves = Bitboards.print_return_all_possible_moves(all_possible_moves)
