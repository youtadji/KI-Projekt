...
"""# Example of how to use the simulate_game function
fen_player = "b0b0b0b0b0b0/1b0b0b0b0b0b01/8/8/8/8/1r0r0r0r0r0r01/r0r0r0r0r0r0 b"

#fen = "b0b0b0b0b0b0/6b01/8/2r05/3r0r03/2r0r0r01b01/4r0r02/2r03"
move = simulate_game(fen_player)
print("MOVE : ", move)
#xxxxxx"""